          ...
          <div className="stats_division">
            <div className="points_column">
              <div className="points_header">
                <img className="stats_logo" src={Teams[0].logo} alt="team logo" />
              ...
              <ul className="leader_stats_points">
                <li className="stats_item"><p className="stats_item_index">1.</p> <p className="stats_item_name">Player Name</p> <p className="stats_item_total">57</p></li>
                <li className="stats_item"><p className="stats_item_index">2.</p> <p className="stats_item_name">Player Name</p> <p className="stats_item_total">57</p></li>
                <li className="stats_item"><p className="stats_item_index">3.</p> <p className="stats_item_name">Player Name</p> <p className="stats_item_total">57</p></li>
                <li className="stats_item"><p className="stats_item_index">4.</p> <p className="stats_item_name">Player Name</p> <p className="stats_item_total">57</p></li>
                <li className="stats_item"><p className="stats_item_index">5.</p> <p className="stats_item_name">Player Name</p> <p className="stats_item_total">57</p></li>
              </ul>
            </div>
          </div>
          <div className="stats_division">
